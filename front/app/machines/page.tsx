...
import { Cpu, LogOut, User, Sun, Moon, Calendar, CheckSquare, Package, BarChart3, FileSpreadsheet, LayoutDashboard, Zap } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="mb-12 text-center">
          <h1 className="text-6xl font-extrabold mb-4 text-white">
            Analyse <span className="text-blue-600 dark:text-[#8c68d8]">Machines</span>
          </h1>
          <p className="text-xl text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
            Suivez et optimisez les performances de vos machines de production
          </p>
        </div>

        {/* Grid de cartes pour les machines */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-6xl mx-auto">
          {/* Laser Bodor */}
          <button
            onClick={() => router.push('/machines/laser-bodor')}
            className="group h-full"
          >
            <div className="border-2 border-gray-800 dark:border-white bg-blue-100/50 dark:bg-white/5 backdrop-blur-sm text-gray-800 dark:text-white font-semibold py-12 px-8 rounded-2xl shadow-xl text-xl hover:bg-blue-200/50 dark:hover:bg-white/10 hover:scale-105 transition-all duration-300 cursor-pointer flex flex-col items-center gap-6 h-full min-h-[300px] justify-between">
              <div className="w-20 h-20 bg-gradient-to-br from-cyan-600 to-cyan-700 rounded-2xl flex items-center justify-center shadow-lg group-hover:shadow-xl transition-shadow">
                <Zap className="w-10 h-10 text-white" />
              </div>
              <div className="text-center flex-1 flex flex-col justify-center">
                <h2 className="text-3xl font-bold mb-2">Laser Bodor</h2>
                <p className="text-lg text-gray-600 dark:text-gray-300 leading-relaxed">
                  Consultez les statistiques de production et les temps d'utilisation de votre machine laser.
                </p>
              </div>
          ...
          {/* Placeholder pour une future machine */}
          <div className="border-2 border-dashed border-gray-400 dark:border-gray-600 bg-gray-100/30 dark:bg-white/5 backdrop-blur-sm text-gray-500 dark:text-gray-400 font-semibold py-12 px-8 rounded-2xl shadow-xl text-xl flex flex-col items-center gap-6 h-full min-h-[300px] justify-center opacity-50">
            <div className="w-20 h-20 bg-gray-300 dark:bg-gray-700 rounded-2xl flex items-center justify-center">
              <Cpu className="w-10 h-10 text-gray-500 dark:text-gray-500" />
            </div>
            <div className="text-center">
              <h2 className="text-2xl font-bold mb-2">Prochainement</h2>
